...
import com.jty.entity.Role;
import com.jty.entity.Token;
import com.jty.entity.TokenType;
import com.jty.entity.User;
import com.jty.response.Result;
import com.jty.security.config.JwtService;
...
public class AuthenticationService {
  ...
  public Result register(RegisterRequest request) {
    if (StringUtils.isNoneBlank(request.getNickname()) &&
            StringUtils.isNoneBlank(request.getUsername()) &&
